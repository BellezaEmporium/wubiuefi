...
class CDBootPage(Page):
    ...
    def on_init(self):
        ...
        txt = _(
            "If your machine cannot boot off the CD, this program will install a new boot menu entry "
            "to help you boot from CD. In most cases this program is not needed, and it is sufficient "
            "to reboot with the CD-Rom in the tray.\n\nDo you want to proceed and install the CD booter?"
        )
