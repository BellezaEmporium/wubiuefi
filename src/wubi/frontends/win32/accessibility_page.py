...
class AccessibilityPage(Page):
    def on_init(self):
        ...
        distro_name = getattr(self.info.distro, "name", self.info.distro)
        ...
        self.main.visibility_group = ui.GroupBox(
            self.main, h, h * 1, w + h * 2, h * 6 - 10, text=_("Visibility Aids")
        )
        self.main.visibility1_button = ui.RadioButton(
            self.main, h * 2, h * 2, w, h, text=_("Visibility1")
        )
        self.main.visibility2_button = ui.RadioButton(
            self.main, h * 2, h * 3, w, h, text=_("Visibility2")
        )
        self.main.visibility3_button = ui.RadioButton(
            self.main, h * 2, h * 4, w, h, text=_("Visibility3")
        )
        self.main.braille_button = ui.RadioButton(
            self.main, h * 2, h * 5, w, h, text=_("Braille")
        )

        self.main.mobility_group = ui.GroupBox(
            self.main, w + h * 4, h * 1, w + h * 2, h * 4 - 10, text=_("Mobility Aids")
        )
        self.main.mobility1_button = ui.RadioButton(
            self.main, w + h * 5, h * 2, w, h, text=_("Mobility1")
        )
        self.main.mobility2_button = ui.RadioButton(
            self.main, w + h * 5, h * 3, w, h, text=_("Mobility2")
        )

        self.main.no_aids_button = ui.RadioButton(
            self.main, w + h * 5, h * 5 + 6, w, 20, text=_("None")
        )
