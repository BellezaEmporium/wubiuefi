...
I STRONGLY advise disabling Secure Boot BEFORE launching yourself into this for now, as I haven't done the necessary for signing stuff (yet). (Might also get blocked by Windows App Control on Win10+ computers).
